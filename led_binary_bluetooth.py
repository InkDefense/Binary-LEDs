#binary representation starts at 0
#add() adds 1 and subtract() subtracts 1
#essentially, it's just a counter
...
while(user_input != "-1"):
    ...
    #print("1 to increase, 0 to decrease value:")
    user_input = user_input + (str(client_socket.recv(1024)))[2:3];
    print(user_input)
